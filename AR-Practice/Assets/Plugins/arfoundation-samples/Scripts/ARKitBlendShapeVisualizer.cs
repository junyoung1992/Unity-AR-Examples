...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    public class ARKitBlendShapeVisualizer : MonoBehaviour
    {
        ...
        private int leftEyeIndex = 0;
        private int rightEyeIndex = 0;
        ...
        {
            if (leftEyeIndex == index)
            {
                var strength = 0.000001f * (100-value) * (100-value);
                leftEye.localScale = new Vector3(x:1, y:1, z:strength);
            }
            if (rightEyeIndex == index)
            {
                var strength = 0.000001f * (100-value) * (100-value);
                rightEye.localScale = new Vector3(x:1, y:1, z:strength);
            }
        }
    }
}